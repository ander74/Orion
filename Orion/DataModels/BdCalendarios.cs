    ...
    public static class BdCalendarios {
        ...
        public static IEnumerable<Calendario> GetCalendarios(int año, int mes) {
            ...
            using (OleDbConnection conexion = new OleDbConnection(App.Global.CadenaConexion)) {
                ...
                string comandoSQL = DbService2.GetCalendarios;
                ...
                try {
                    ...
                    foreach (Calendario calendario in lista) {
                        if (calendario.Nuevo) {
                            ...
                            //}
                            // Eliminar lo de arriba, ya que se debe añadir el conductor al añadir un calendario a la tabla.
        ...
        public static void BorrarCalendarios(List<Calendario> lista) {
            ...
            using (OleDbConnection conexion = new OleDbConnection(App.Global.CadenaConexion)) {
                ...
                string SQLBorrar = DbService2.BorrarCalendario;
